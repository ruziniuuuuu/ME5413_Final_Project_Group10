...
@fig:fastlio_map exemplifies the efficicency of the FAST-LIO algorithm, illustrating its progress in refining the raw point cloud to eliminate noise while retaining critical structural details within the mini-factory environment. The resultant high-resolution map elucidates FAST-LIO's robust data processing capabilities, underpinning its utility for precise localization and comprehensive environmental modeling.
...
== FAST-LIO Performance Evaluation
